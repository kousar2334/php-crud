...
<div class="container-fluid">
  <?php
    ...
    <tr>
      ...
      <td>
        <a href="app/controller/userController.php?view=<?php echo $user['id']; ?>" class="btn btn-primary">View</a>
        <a href="app/controller/userController.php?edit=<?php echo $user['id']; ?>" class="btn btn-info">Edit</a>
